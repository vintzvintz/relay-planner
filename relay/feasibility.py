...
# ---------------------------------------------------------------------------
# Modèle partiel — variante de Model avec contraintes optionnelles
# ---------------------------------------------------------------------------

class _PartialModel(Model):
    """Model avec des groupes de contraintes désactivables."""
    ...
    # ------------------------------------------------------------------
    # Variantes partielles des méthodes de Model
    # ------------------------------------------------------------------
...
class FeasibilityAnalyser:
    """Diagnostique les contraintes causant l'infaisabilité d'un Constraints."""
    ...
    def run(self) -> None:
        ...
        families = [
            ...
            ("Pairings forcés (SharedLeg)",          dict(skip_forced_pairings=True)),
...
def analyse(constraints: Constraints, timeout: float = 10.0) -> None:
